...
root_agent = Agent(
   ...
   instruction='''
            ...
            2. **Delegation**: -  If the user's question relates to retrieving data, quantities, locations, picklists, GRNs, or any information from the database, you **MUST** call the 'analytics_agent'  with the full original query.
...
# YOU MUST:
# - Call `warehouse_item_api_agent`
# - Pass the FULL ORIGINAL USER QUERY
# - RETURN ONLY the tool call
# - STOP


# 4. Route to `warehouse_item_api_agent` if query is about:
#    - items
#    - item code
#    - SKU
#    - material
#    - product
#    - inventory items
#    - pagination follow-ups like:
#      "next page"
#      "show more"
#      "continue"
#      "load more"

# 5. Picklist / Picking / Putaway → picklist_api_agent
# 6. GRN / Goods Received / Inbound → grn_api_agent
# --------------------------------------------------
# CRITICAL RULE
# --------------------------------------------------
# Routing is evaluated on EVERY user message.
# You do NOT remember previous turns.
# """,
#     sub_agents=[
#         # machine_agent,
#         # warehouse_item_api_agent,
#         # grn_api_agent,
#         # picklist_api_agent
#         # warehouse_agent,
#     #     # manual_agent,
