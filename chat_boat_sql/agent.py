...
#             6.  If state.selectedAgent is provided in the session state, you must NOT
#                     call transfer_to_agent. Always answer using the current agent.

#                     Routing using transfer_to_agent should only happen when
#                     state.selectedAgent is not defined.
